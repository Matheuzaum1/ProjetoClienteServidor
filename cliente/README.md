...
Interface web simples para consumir a API Laravel do projeto.
...
- Campo para IP/URL do servidor
- Campo para porta no endpoint configurado pela URL base
- Operacoes de EP-1 em tela unica
- Token JWT salvo e reutilizado automaticamente